...
const portfolio: React.FC = () => {
  ...
  return (
    <div>
    <div id='Home' className='h-full w-full flex-col justify-center items-center '>
      <div className='flex justify-center items-center h-screen w-[90%] md:w-screen ' style={{ backgroundImage: `url(${pattern})` }}>
